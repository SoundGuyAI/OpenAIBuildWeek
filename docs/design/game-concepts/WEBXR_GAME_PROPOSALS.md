...
![Five connected stages show read, choose, act, world response, and learning returning to the start.](infographics/universal-loop.svg)
...
![Desktop, mobile, and XR input lanes converge on one shared game verb and one shared world response.](infographics/platform-braid.svg)
...
![Twenty numbered concepts spread across local-to-systemic action and puzzle-to-expression axes.](infographics/originality-map.svg)

<div style="break-after: page;"></div>

# Gallery 1 - Systems, agents, and social strategy

![Four connected miniature worlds: an NPC mentor and player route a task around an agent workbench, ghost trains cross layered decades, tiny nations build promises into a map, and surreal objects pass through a dream factory.](assets/generated/01-systems-agents-strategy.webp)
...
![A pulse reveals an invisible cave, a runaway sculpture freezes under a museum spotlight, an artifact reconstructs a ruined room backward through time, and environmental traces expose an unseen zoo creature.](assets/generated/02-perception-evidence-invisible-worlds.webp)
...
![Gravity threads bend star-seeds into a constellation, lamp-lit sculptures cast a bridge for a tiny traveler, a paper city folds into a rescue route, and a brass siphon moves size from a giant key into a tiny door.](assets/generated/03-forces-shadows-folds-scale.webp)
...
![A pressure shape bends clouds over an island, a terrarium evolves through generations, a miniature sun moves around a clockwork room, and a pearl moon machine carries a repaired sequence of signal tokens.](assets/generated/04-weather-ecology-light-cycles.webp)
...
![A player conducts a singing machine, a camera aligns a moon-whale through a puddle portal, an alien exchanges luminous motion glyphs, and an actor continues while the stage changes genre.](assets/generated/05-music-photography-language-improv.webp)
...
![Twenty concepts are plotted by implementation effort and integration uncertainty with a two-day buildable front.](infographics/scope-risk-matrix.svg)
...
![Twenty worlds narrow to five prototypes and one audience-tested loop.](infographics/shortlist-funnel.svg)
