...
| 05 | Desktop/touch Playwright | Actual canvas interactions complete recovery and campaign; native touch does not scroll | Pass on clean PR runner: 5 applicable tests passed, 5 project skips, no application errors/request failures/HTTP errors; initial job failed only because the artifact path was empty | `browser-qa.md` |
